...
APP_PORT=8080          # 应用端口
HEALTH_CHECK_URL=http://127.0.0.1:${APP_PORT}/test01  # 应用健康检查URL
HEALTH_CHECK_FILE_DIR=/home/admin/status   # 脚本会在这个目录下生成nginx-status文件
APP_HOME=/home/admin/test01  # 从package.tgz中解压出来的jar包放到这个目录下
WAR_NAME=test01.war # jar包的名字
...
start_application() {
    ...
    cp /home/admin/test01/test01.war /usr/local/apache-tomcat/webapps/
